                ...
                <Th
                  info={{
                    popover: (
                      <PopoverHelp
                        name={'time-to-live'}
                        label={t('caches.entries.column-lifespan')}
                        content={t('caches.column-lifespan-tooltip')}
                      />
                    )
                  }}
                  colSpan={1}
                ...
                <Th
                  info={{
                    popover: (
                      <PopoverHelp
                        name={'max-idle'}
                        label={t('caches.entries.column-maxidle')}
                        content={t('caches.entries.column-maxidle-tooltip')}
                      />
                    )
                  }}
                  colSpan={1}
